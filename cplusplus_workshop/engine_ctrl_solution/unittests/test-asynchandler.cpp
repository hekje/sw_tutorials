...
enum class CallbackTypeTest
{
    ...
    struct CallbackActionTest
    {
        ...
        bool operator==(const CallbackActionTest& other) const
        {
            return (type == other.type &&
                    req_one == other.req_one &&
                    req_two == other.req_two &&
                    val_three == other.val_three &&
    ...
    public:
        ...
        virtual ~CustomHandler()
        {
            ...
            SLLog::log_info("CustomHandler::~CustomHandler - CustomHandler terminated gracefully");
        }
       ...
       {
           SLLog::log_info("CustomHandler::test_parent_stop - Simulate stopping the AsyncHandler parent");
    ...
    //! This is for testing parent-child relationship between AsyncHandler and BadHandler:
    //! To test if the application will not crash if the AsyncHandler parent will call the
    //! virtual "handle_trigger_action" function if the child has already been destructed
    ...
    class IllegalCallParentInCallbacklHandler : public AsyncHandler<struct CallbackActionTest>
    {
    public:
        IllegalCallParentInCallbacklHandler() :
        m_counter{0}
        {}
        virtual ~IllegalCallParentInCallbacklHandler()
        {
            ...
            SLLog::log_info("IllegalCallParentInCallbacklHandler::~IllegalCallParentInCallbacklHandler - CustomHandler terminated gracefully");
        }
...
{
    IllegalCallParentInCallbacklHandler* handler = new IllegalCallParentInCallbacklHandler();
    uint32_t counter = 0;
