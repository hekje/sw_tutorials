...
public:
    ...
    void
    start_timer(uint32_t timeout_ms)
    {
...
public:
    TimerDeadlockTester() :
        m_counter{0}
    {
        m_timer.set_timer_callback(std::bind(&TimerDeadlockTester::timer_callback, this));
    ...
    timer_callback()
    {
        ...
        SLLog::log_info("TimerDeadlockTester::timer_callback - Illegal call to VCSTimer!");
...
public:
    ...
    void
    start_repeat_timer(uint32_t timeout_ms)
    {
...
public:
    ...
    timer_callback()
    {
        ...
        SLLog::log_info("TriggerTimerDeadlockTester::timer_callback - Illegal call to VCSTimer!");
